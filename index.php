    ...
    <div class="container">
      <div class="row py-3">
        <div class="col-md-12 text-center">
          <p><b>Copyright &copy; 2024 - Developed by Cabanilla, Dan Lloyd doing the Dynamic Portfolio Activity</b></p>
        </div>
      </div>
    </div>
  </footer>
...
<script>
    var typed = new Typed('#role', {
        strings: ['Web Developer', 'Php Developer', 'Python Developer', ' Software Intern'],
        typeSpeed: 100,
        loop: true,
        fadeOut: true
    });
